...
{{--
    If the role names match the file names of your navbars (e.g., nav_admin.blade.php for admin), you can dynamically include the navbar without multiple conditionals:
    @if (Auth::check())
    @include('layouts.nav_' . Auth::user()->role)
@endif --}}
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;"
                                    ...
                                    <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 40"
                                        ...
                                        xmlns:xlink="http://www.w3.org/1999/xlink">
                                        {{-- @if (Auth::user()->role === 'admin')
                                        <a href="{{ route('admin.editProfile', $user->id) }}" class="btn btn-primary">Edit Profile</a>
                                    @endif --}}
                                    ...
                                    {{-- <button class="btn btn-warning">
                                        <i class="bi bi-pencil"></i> <!-- Optional Icon -->
                                        <span class="ms-1">
                                            <a href="{{ route('user.edit', ['user' => $user->id]) }}" class="text-white text-decoration-none">Edit</a>
                                        </span>
                                    </button> --}}
                    ...
                    <div class="card-body p-3">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item border-0 ps-0 pb-0">
                                <strong class="text-dark text-sm">Birth Date:</strong>{{$user->birth_date}} &nbsp;
